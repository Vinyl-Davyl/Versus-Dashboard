...
> Admin dashboard V1 with functional components, featuring widgets, activity charts, data tables and paginations, create and edit function on product. Reusable UI based built on React.

### ✨ [Live Demo](https://versusboard.netlify.app)
